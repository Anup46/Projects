...
public class Select extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Select Owner/Seller");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 255, 0));
        jLabel2.setText("For Computer Shop");

        jComboBox2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Owner", "Seller" }));
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/inventory.jpg"))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        String ok = (String)jComboBox2.getSelectedItem();
        if(ok.equals("Owner"))
        {
